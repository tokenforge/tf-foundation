...
contract TokenForge1155v2 is ERC1155Burnable, ERC1155Supply, Ownable, AccessControlEnumerable {
    ...
    modifier onlyOwnerOrAdmin() {
        require(
            ...
            "TokenForge1155v2: caller is not the owner nor admin"
        );
        _;
    }

    modifier onlyMinter() {
        require(hasRole(MINTER_ROLE, _msgSender()), "TokenForge1155v2: caller has not minter role");
        _;
    }
    ...
    function mint(
        ...
        mintTo(msg.sender, tokenId, amount, tokenUri);
    }
    ...
    function mintWithSignature(
        ...
        mintToWithSignature(msg.sender, tokenId, amount, tokenUri, signature);
    }
